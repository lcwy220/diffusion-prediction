...
def feature_extract(event,event_count,start_ts,end_ts,event_trend_delte_event):
    ...
    #return [field_multi[0],field_multi[1],total_num,total_user_fans,total_comment,total_retweet,total_sensitive,total_sensitive_ratio,total_negtive,total_negtive_ratio,total_important_user,total_important_user_ratio,total_origin_type,origin_ratio,total_retweet_type,retweet_ratio,total_comment_type,comment_ratio]
...
def feature_compute(event):
    ...
    fo_feature = open('005_feature_delete2_0103.txt','wb')
    fo_truth = open('005_truth_delete2_0103.txt','wb')
    #fo_at = open('005_at_count_0103.txt','wb')
	...
	event_count = item[3]
        ...
        feature_extract(event,event_count,start_ts,end_ts,event_trend_delta[event])
    #print 'event_trend::::',event_trend
