...
from utils import get_during_keywords_es,get_topics_river,get_weibo_content,get_subopinion,get_symbol_weibo,get_topics
...
def during_keywords():
    ...
    keywords = json.loads(get_during_keywords_es(topic,start_ts,end_ts))
