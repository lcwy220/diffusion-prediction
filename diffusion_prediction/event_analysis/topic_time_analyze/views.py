...
from utils import  get_weibo_by_time_es,get_time_count_es,get_predict_count
...
def MtypeCount():      #每类微博的数量
    ...
    results = get_time_count_es(topic,start_ts,end_ts,during)
...
def TimeOrderWeibos():
    ...
    ts_arr = []
    weibos = get_weibo_by_time_es(topic,start_ts,end_ts,sort_item)
